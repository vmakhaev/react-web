...
var _ReactEasing = require('../Easing/Easing.web');
...
var _requestAnimationFrame = require('./polyfills/requestAnimationFrame');
...
var TimingAnimation = function (_Animation) {
  ...
  _createClass(TimingAnimation, [{
    ...
    value: function start(fromValue, onUpdate, onEnd) {
      ...
      var start = function start() {
        if (_this3._duration === 0) {
          ...
          _this3._animationFrame = (0, _requestAnimationFrame2.default)(_this3.onUpdate.bind(_this3));
        }
      };
      if (this._delay) {
    ...
    value: function onUpdate() {
      ...
      if (this.__active) {
        this._animationFrame = (0, _requestAnimationFrame2.default)(this.onUpdate.bind(this));
      }
    }
  }, {
    key: 'stop',
  ...
  _createClass(AnimatedValue, [{
    ...
    value: function animate(animation, callback) {
      ...
      if (animation.__isInteraction) {
        handle = _ReactInteractionManager2.default.createInteractionHandle();
      }
